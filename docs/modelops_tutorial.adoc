...
This section requires admin access because you'll be installing operators and creating new projects.
...
=== Recap
* We pushed a model into our organization's local Quay repository.
